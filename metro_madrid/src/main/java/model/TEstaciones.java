...
public class TEstaciones implements java.io.Serializable {
	...
	public TEstaciones(int codEstacion, String nombre, String direccion, Integer numaccesos, Integer numlineas,
			Integer numviajesdestino, Integer numviajesprocedencia, Set<TLineaEstacion> TLineaEstacions,
			Set<TAccesos> TAccesoses, Set<TViajes> TViajesesForEstaciondestino,
			Set<TViajes> TViajesesForEstacionorigen) {
		this.codEstacion = codEstacion;
		this.nombre = nombre;
		this.direccion = direccion;
